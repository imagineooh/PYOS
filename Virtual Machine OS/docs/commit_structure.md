...
- FIX: Fix a bug in existing file
- DEPFIX: Fix dependency injections in files
- PREPFEAT: Prepare for a future feat
- DOC: Document a function
- FEATDOC: Modify project documentation
- ADDDOC: Add file (md) to project documentation
These keyword messages can be accompanied by their importance:
- Small
- Med
- IMPORTANT
